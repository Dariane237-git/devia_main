<x-app-layout>
    ...
    <div class="page-header">
        <div>
            <h2 style="font-size: 24px; font-weight: 800; color: #111827; margin-bottom: 4px;">Nouvel Utilisateur</h2>
            <p style="color: #6B7280; font-size: 14px;">Créez un compte pour un employé ou un client.</p>
        </div>
    ...
    <!-- Alpine X-DATA form (to show/hide fields based on role selected) -->
    <div class="form-card" x-data="{ selectedRole: '{{ old('id_role', '') }}' }">
        <form method="POST" action="{{ route('users.store') }}">
            ...
            <div class="form-section">
                ...
                <div class="grid-2">
                    <div class="field-group">
                        ...
                        <input id="nom" type="text" name="nom" class="field-input" value="{{ old('nom') }}" required>
                    ...
                    <div class="field-group">
                        ...
                        <input id="prenom" type="text" name="prenom" class="field-input" value="{{ old('prenom') }}" required>
                ...
                <div class="grid-2">
                    ...
                    <div class="field-group">
                        ...
                        <input id="tel" type="text" name="tel" class="field-input" value="{{ old('tel') }}">
            ...
            <div class="form-section">
                ...
                <!-- Champs si rôle "Client" (généralement ID 1) -->
                <div x-show="selectedRole == 1" style="display:none; background:#F0FDF4; padding:20px; border-radius:12px; border:1px solid #DCFCE7; margin-top:20px;">
                    ...
                    <div class="grid-2">
                        ...
                        <div class="field-group" style="margin-bottom:0;">
                            ...
                            <input type="text" name="adresse_clt" class="field-input" value="{{ old('adresse_clt') }}">
                            @error('adresse_clt') <span class="error-msg">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>

                <!-- Champs si rôle "Technicien" (généralement ID 4) -->
                <div x-show="selectedRole == 4" style="display:none; background:#FFF7ED; padding:20px; border-radius:12px; border:1px solid #FFEDD5; margin-top:20px;">
                    ...
                    <div class="field-group" style="margin-bottom:0; max-width: 50%;">
                        ...
                        <input type="text" name="specialite" class="field-input" value="{{ old('specialite') }}" placeholder="Ex: Réseaux, Matériel, Logiciel...">
            ...
            <div class="form-section" style="margin-bottom: 24px;">
                ...
                <div class="grid-2">
                    <div class="field-group">
                        <label class="field-label" for="password">Mot de passe temporaire <span style="color:#EF4444;">*</span></label>
                        <input id="password" type="password" name="password" class="field-input" required>
                        <span style="font-size:12px;color:#9CA3AF;margin-top:4px;display:block;">Minimum 8 caractères. L'utilisateur pourra le changer.</span>
                        @error('password') <span class="error-msg">{{ $message }}</span> @enderror
                    </div>
                    <div class="field-group">
                        <label class="field-label" for="password_confirmation">Confirmer le mot de passe <span style="color:#EF4444;">*</span></label>
